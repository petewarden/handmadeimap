<?php
/**
 * The main POP3 class is by Manuel Lemos:
 * http://phpclasses.ranchoweb.com/browse/package/2.html
 * It's licensed under the same BSD license
 *
 * I've added some simple wrappers around it so the calling conventions
 * are similar to the IMAP code built on raw sockets.
 *
